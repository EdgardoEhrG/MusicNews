  ...
  new Vuex.Store({
    ...
    mutations: {
      ...
      editPost(state, payload) {
        const postIndex = state.prevPosts.findIndex(
    ...
    actions: {
      ...
      NUXT_SERVER_INIT({ commit }) {
        return axios
          .get("https://music-news-cdc05.firebaseio.com/posts.json")
          .then((res) => {
            const postArray = [];
      ...
      ADD_POST({ commit }, payload) {
        ...
        return axios
          .post(
            "https://music-news-cdc05.firebaseio.com/posts.json?auth=" +
              this.state.token,
            createdPost
          )
          .then((res) => {
      ...
      EDIT_POST({ commit }, payload) {
        return axios
          .put(
            "https://music-news-cdc05.firebaseio.com/posts/" +
              payload.id +
              ".json?auth=" +
              this.state.token,
            payload
      ...
      AUTHENTICATE_USER({ commit }, payload) {
        ...
        return axios
          ...
          .then((result) => {
            ...
            return axios
              .post("http://localhost:3000/api/track-data", {
                data: "Authenticated",
              })
              .then((res) => {
                this.$router.push("/");
